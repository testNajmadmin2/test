...
/**
 * Small application service orchestrating the kata use cases.
 */
@Service
public class LoyaltyService {
    ...
    /**
     * Creates the account on first earn and stores a new point bucket.
     */
    ...
    /**
     * Generic spend entry point used by payment, voucher and donation.
     */
    ...
    /**
     * Returns the usable balance and current buckets after applying expiration.
     */
    ...
    /**
     * Returns the active buckets that should trigger a notification soon.
     */
    ...
    /**
     * Explicit endpoint used by the kata to process expiration now.
     */
